...
- [ ] **Build the GPT Tokenizer:** Build a Byte Pair Encoding (BPE) tokenizer from scratch, similar to the one used in OpenAI's GPT models base on [Andrej Karpathy's 'Let's build the GPT Tokenizer' video](https://www.youtube.com/watch?v=zduSFxRajkE).
