## To-Do List: LLM Course - Practical Tasks
...
- [x] **Training a new tokenizer from an old one:** <a target="_blank" href="https://colab.research.google.com/drive/1452WFn66MZzYylTNcL6hV5Zd45sskzs7?usp=sharing"> <img src="https://colab.research.google.com/assets/colab-badge.svg" alt="Open In Colab"/></a>
- [x] **Custom Tokenizer Training:** Train custom tokenizers on custom text dataset with three different tokenizer models (BPE, WordPiece, and Unigram) <a target="_blank" href="https://colab.research.google.com/drive/1uYFoxwCKwshkchBgQ4y4z9cDfKRlwZ-e?usp=sharing"> <img src="https://colab.research.google.com/assets/colab-badge.svg" alt="Open In Colab"/></a>
...
This revised to-do list provides practical tasks for each module, focusing on hands-on implementation and experimentation.  Remember to adapt the tasks and datasets to your specific interests and resources. Good luck with your LLM journey!
